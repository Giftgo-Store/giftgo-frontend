...
const Footer = () => {
    return (
      <>
        <div className="py-[56px] px-[8%] flex flex-col justify-center items-center gap-[40px] bg-primary w-full">
          ...
          <div className="flex justify-between items-center w-full">
            <div className="flex justify-start gap-[24px] text-white w-[30%]">
            ...
            <div className="flex justify-end items-center gap-2 text-white w-[30%]">
